...
SELECT
    ...
    SUM(CASE WHEN m.msuccess = 'TRUE' THEN 1 ELSE 0 END) AS SuccessCount,
    SUM(CASE WHEN m.death = 'TRUE' THEN 1 ELSE 0 END) AS DeathCount,
    
    CAST(SUM(CASE WHEN m.msuccess = 'TRUE' THEN 1 ELSE 0 END) AS FLOAT) 
        / COUNT(*) * 100 AS SummitRatePercent,
    
    CAST(SUM(CASE WHEN m.death = 'TRUE' THEN 1 ELSE 0 END) AS FLOAT) 
    ...
    CAST(SUM(CASE WHEN m.msuccess = 'TRUE' THEN 1 ELSE 0 END) AS FLOAT)
        / NULLIF(SUM(SUM(CASE WHEN m.msuccess = 'TRUE' THEN 1 ELSE 0 END)) OVER (), 0) * 100 AS ShareOfSummitsPercent
...
SELECT 
    ...
    CASE 
        WHEN CAST(e.tothired AS INT) = 0 THEN 'No Hired Staff'
    ...
    SUM(CASE WHEN e.success1 = 'TRUE' THEN 1 ELSE 0 END) AS SuccessfulExpeditions,
    
    CAST(SUM(CASE WHEN e.success1 = 'TRUE' THEN 1 ELSE 0 END) AS FLOAT)
